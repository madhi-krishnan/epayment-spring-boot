...
ENTRYPOINT ["java","-agentpath:/opt/cprof/profiler_java_agent.so=-logtostderr","-Dcom.google.cdbg.module=e-payment-gke","-Dcom.google.cdbg.version=2.0","-Dcom.google.cdbg.breakpoints.enable_canary=true","-cprof_enable_heap_sampling=true","-cprof_service=epayment-gke","-cprof_service_version=1.0","-jar","/app/e-payment.jar"]