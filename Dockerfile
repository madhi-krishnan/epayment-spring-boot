...
CMD "java","-agentpath:/opt/cdbg/cdbg_java_agent.so,-Dcom.google.cdbg.module=e-payment,-Dcom.google.cdbg.version=1.0,-Dcom.google.cdbg.breakpoints.enable_canary=true","-jar","/app/e-payment.jar"]